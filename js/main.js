window.onload = function() {
    ...
    for (let item of document.querySelectorAll('.menu button.menu_buy')) {
    ...
    // Автор
    for (let item of document.querySelectorAll('a[href="#author"]')) {
        item.addEventListener("click", function (e) {
    ...
    // Особенности
    for (let item of document.querySelectorAll('a[href="#features"]')) {
        item.addEventListener("click", function (e) {
    ...
    // Содержание курса
    for (let item of document.querySelectorAll('a[href="#about"]')) {
        item.addEventListener("click", function (e) {
    ...
    for (let item of document.querySelectorAll('li[mytitle]')) {
        item.addEventListener('click', function (e) {
